...
\usemodule
  ...
  [%%%%%%%%%%%%%%%%%%%%%
   % Choose a style
  %%%%%%%%%%%%%%%%%%%%%%
    style=BigNumber,            % stylecolor=blue|red
  % style=BottomSquares,
  % style=Boxed,
  % style=default,
  % style=Ellipse,
  % style=Embossed,
  % style=Framed,               % stylebottom=square|stripes
  % style=FramedTitle,
  % style=HorizontalStripes,    % stylecolor=blue|green|red
  % style=NarrowStripes,        % stylecolor=blue|green|red
  % style=RainbowStripe,
  % style=Rounded,
  % style=Shaded,               % stylecolor=blue|green
  % style=SideSquares,
  % style=Split,
  % style=Sunrise,
  % style=Swoosh,
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%
    % Choose a stylecolor.
    % Only a few styles support stylecolor
  %%%%%%%%%%%%%%%%%%%%%%%%%
    stylecolor=blue, % supported by:
    % BigNumber, HorizontalStripes, NarrowStripes, Shaded
  % stylecolor=red, % supported by:
    % BigNumber, HorizontalStripes, NarrowStripes
  % stylecolor=green, % supported by:
    % HorizontalStripes, NarrowStripes, Shaded
  %%%%%%%%%%%%%%%%%%%%%%%%%
    % Choose a stylebottom.
    % Only one style support stylebottom
  %%%%%%%%%%%%%%%%%%%%%%%%%
    stylebottom=square, % supported by:
    % Framed
  % stylebottom=stripes, % supported by:
    % Framed
  ]
