...
\setuphead[section,subsubject][numberstyle=sansbold,textstyle=sansbold]
...
\section Examples of different styles
...
\subsubject{Framed: with \options{style=square}}
\ShowStyle {Framed-square}

\subsubject{Framed: with \options{style=stripe}}
