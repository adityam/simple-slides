...
{\tt\from[practex]}). With time, he extended these macros into a collection
...
chosen using \options{color} and \options{alternative} keys. The available styles are
shown below along with the details of their variants.
...
placed in horizontal or vertical layout; fir examples, see \in
