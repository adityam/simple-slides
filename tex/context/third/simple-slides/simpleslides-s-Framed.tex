...
\setuplayout [simpleslides:layout:vertical]  [backspace=1cm]
\setuplayout [simpleslides:layout:title]     [header=0cm,bacspace=0.5cm]
...
\define\NormalHeight        {.93\textheight}
\define\NormalWidth         {.485\textwidth}
\define\PictureFrameHeight  {.93\textheight}
...
\definecolor [simpleslides:itemize:color]     [simpleslides:contrastcolor:1]
...
\startsetups simpleslides:bottom:square
\defineoverlay
  [simpleslides:background:ornament]
  [\uniqueMPgraphic{simpleslides:MP:ornament:square}]
\stopsetups

\startsetups simpleslides:bottom:stripe
\defineoverlay
  [simpleslides:background:ornament]
  [\uniqueMPgraphic{simpleslides:MP:ornament:stripe}]
\stopsetups

\startsetups simpleslides:bottom:empty
  \setups{simpleslides:bottom:square}
\stopsetups

%D Now we activate the user's choice

\setups{simpleslides:bottom:\moduleparameter{simpleslides}{bottom}}
