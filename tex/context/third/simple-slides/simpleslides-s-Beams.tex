%D \module
%D   [      file=simpleslides-s-Beams,
%D        version=2007.07.17, 
%D          title=\CONTEXT\ Style File,
%D       subtitle=Presentation Module --- Beams style,
...
%D This file provides the \quotation{Beams} style for the presentation
...
\writestatus{simpleslides}{loading Beams style}

\startmodule[simpleslides-s-Beams]
...
\setuplayout [simpleslides:layout:title]     [header=1.75cm]
