...
\startsetups simpleslides:font:Gothic
  \starttypescript[gothic]
    ...
    \definetypeface [gothic] [tt] [mono]  [modern]   [default] [rscale=1.075]
    \definetypeface [gothic] [mm] [math]  [pagella] [default]
  \stoptypescript
...
\startsetups simpleslides:font:Chancery
  ...
  \starttypescript [chancery]
    \definetypeface [chancery] [rm] [serif] [chorus] [default]
  \stoptypescript 
...
\starttypescript [chancery]
  \definetypeface [chancery] [rm] [serif] [chorus] [encoding=ec]
\stoptypescript 
\usetypescript[chancery]
\setupbodyfont[chancery,\NormalSize]
\stopsetups
