...
%D This module is the first sub-module that is loaded by \filename{simpleslides}.
%D This sets up the style macros for the module. We choose a rather plain style
%D as the default; separate style sub-modules redefine some internal macros to
%D achieve fancier effects.
