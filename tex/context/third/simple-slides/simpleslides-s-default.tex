...
\setupPicture
  [highlight=\v!no,%yes|no|default=no
   \c!alternative=\v!none,%none|ellipse|arrow|gray|default=none
   \c!grid\c!color=darkgreen,
   \c!grid=\v!no,
   \c!sub\c!grid=\v!no,
   steps=5,%controls the number of subdivisions of the subgrid
   \c!rulethickness={OverlayWidth/100},%for ellipse and arrow
...
\chardef\simpleslidesHighlightAlternative\zerocount %0=none, 1=ellipse, 
                                                    %2=arrow, 3=focus
 ...
 \v!bottom\v!right=>\chardef\simpleslidesShadow\plusthree,
  \v!bottom\v!left=>\chardef\simpleslidesShadow\plusfour,
   ...
   \processaction
     ...
     [   ellipse=>\chardef\simpleslidesHighlightAlternative\plusone
...
%D subgrid. Then it checks which alternative (arrow, ellipse, gray) is requested
...
\ifconditional \simpleslidesHighlight
 ...
 \ifcase \simpleslidesHighlightAlternative \or
  \includeMPgraphic{simpleslides:MP:highligh:ellipse} \or
...
%D This is a helper macro to get the dimensions for the ellipse. Taking care of
...
\def\simpleslidesSetEllipseDimensions%
  {\edef\simpleslidesCurrentXscale{\simpleslidesPictureParameter{\c!x\c!scale}}
   \edef\simpleslidesCurrentYscale{\simpleslidesPictureParameter{\c!y\c!scale}}
      \message{: X=\simpleslidesCurrentXscale, Y=\simpleslidesCurrentYscale}
   \processaction
...
%D Metapost graphic to draw a ellipse. The ellipse is centered at (x,y) with a
...
%D the ellipse is \type{rulethickness} and the color is \type{color}. The
%D ellipse is rotated by an angle \type{direction}

\startuseMPgraphic{simpleslides:MP:highligh:ellipse}
  save p; path p;
...
%D same default works for both ellipse and arrows) and is on \type{color} color.
%D
...
%D area are equivalent to that of \type{alternative=ellipse}. The "unfocussed"
