...
%D       subtitle=Presentation Module FramedTitle,
...
\definecolor [simpleslides:variantcolor:1]        [s=.3]
\definecolor [simpleslides:variantcolor:2]        [s=.7]
...
for i := 1 upto NOfPages:
	...
	q := q shifted (b,0) ;
	if (i mod 5<>0):
		draw p shifted (i*5pt,0pt) withcolor \MPcolor{simpleslides:variantcolor:2} ;
		if (i <= PageNumber):
			draw p shifted (i*5pt,0pt) ;
		fi ;
	else:
		draw q shifted (i*5pt,0pt) withcolor \MPcolor{simpleslides:variantcolor:2} ;
		if (i <= PageNumber):
...
% \null
% \vfill
% \framed[corner=round,background=color,backgroundcolor=simpleslides:contrastcolor,frame=off,width=\textwidth,height=.75\textheight,top=\vss,bottom=\vss,align=middle]{\switchtobodyfont[\TitleSize]\color[simpleslides:backgroundcolor]{\PRESTITtitle}\switchtobodyfont[\NormalSize]\blank[line]\color[simpleslides:backgroundcolor]{\PRESTITauthor\blank[2*line]\PRESTITdate}}
% \vfill
% \null}
...
% \define[1]\SlideTitle{\page\HorizontalBackground\setlayer[slidetitle]%
%      {\framed[corner=round,background=color,backgroundcolor=simpleslides:contrastcolor,frame=off,width=\textwidth,height=2.1cm,offset=0pt,top=\vss,bottom=\vss]{\switchtobodyfont[\TitleSize]\color[simpleslides:backgroundcolor]{#1}}}}
