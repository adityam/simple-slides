...
\unexpanded\def\TaspresentSometxtLeft#1%
  {\getvalue{simpleslides:framed:small}[align=left]
                       {\ix\color[simpleslides:backgroundcolor]
                       {#1\quad\strut}}}
...
draw \sometxt[simpleslides:sometxt:left]{\moduleparameter{simpleslides:title}{date}}
     shifted (1cm,y1) ;

draw \sometxt[simpleslides:sometxt:right]{\folio\ of \lastpage}
     shifted (x5,y1) ;

draw \sometxt[simpleslides:sometxt:left]{\moduleparameter{simpleslides:title}{author}}
     shifted (1cm,0) ;

draw \sometxt[simpleslides:sometxt:right]{\moduleparameter{simpleslides:title}{title}}
      shifted (x5,0) ;
